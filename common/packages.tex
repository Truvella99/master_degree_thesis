...
\renewbibmacro*{finentry}{%
    ...
    \finentry}
% Redefine \cite to make text and number blue
...
\let\oldcite\cite
\AtBeginDocument{
    \renewcommand{\cite}[1]{\textcolor{blue}{\hypersetup{citecolor=blue}\oldcite{#1}}}
}
\makeatother
...
% ------------------ \cref REDEFINITION with blue color (only link now) -----------------------------
% ------------------ NORMAL -----------------------------
\crefformat{figure}{
    \unskip\textcolor{black}{ % fig. text color
        fig.~#2\textcolor{blue}{#1}#3} % reference number color
    \unskip
}
\crefformat{table}{
    \unskip\textcolor{black}{ % table text color
        table~#2\textcolor{blue}{#1}#3} % reference number color
    \unskip
}
\crefformat{section}{
    \unskip\textcolor{black}{ % section text color
        section~#2\textcolor{blue}{#1}#3} % reference number color
    \unskip
}
\crefformat{equation}{
    \unskip\textcolor{black}{ % equation text color
        eq.~#2\textcolor{blue}{#1}#3} % reference number color
    \unskip
}
% ------------------ CAPITALIZED -----------------------------
\Crefformat{figure}{
